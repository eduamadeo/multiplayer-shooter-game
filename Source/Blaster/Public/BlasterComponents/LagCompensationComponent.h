...
protected:
	...
	*/
	...
	FShotgunServerSideRewindResult ShotgunConfirmHit(TArray<FFramePackage>& FramePackages, const FVector_NetQuantize TraceStart, const TArray<FVector_NetQuantize>& HitLocations);
